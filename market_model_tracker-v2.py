...
class BlackScholesEngine:
    ...
    def calculate_greeks(S, K, r, t, sigma, option_type='c'):
        ...
        K: Strike price
        r: Risk-free rate (decimal, e.g., 0.068 for 6.8% Indian interest rate)
...
def execute_model_suite():
    ...
    print("=" * 75)
    print("      INDIAN STOCK MARKET INDICATOR & DERIVATIVE RISK EVALUATOR (v2)")
    print("=" * 75)
    ...
    results_df.to_csv('/workspace/scratch/market_summary_model-v2.csv', index=False)
    options_chain.to_csv('/workspace/scratch/reliance_options_chain_analysis-v2.csv', index=False)
